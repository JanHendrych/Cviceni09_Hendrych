global using static GenericsHashTableLibrary.Tests.TestUtils;
...
internal static class TestUtils
{
    ...
    private static Assembly testedAssembly;

    static TestUtils()
    {
        testedAssembly = typeof(HookForTests).Assembly;
    }

    public static Type GetTestedType(string typename)
    {
        Type? type = testedAssembly.GetType(typename);
        Assert.IsNotNull(type, $"This test requires implementation of type '{typename}'");
